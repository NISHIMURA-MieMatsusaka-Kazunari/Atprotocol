...
use constant {
	...
	CHAT_PROXY	=> 'did:web:api.bsky.chat',
...
sub convo_listConvos {
	...
	eval{
		...
		print $self->{requestUri}.'/xrpc/chat.bsky.convo.listConvos?'.$query."\n";
		my $req = HTTP::Request->new ('GET', 
		$self->{requestUri}.'/xrpc/chat.bsky.convo.listConvos?'.$query,
		['Authorization' => 'Bearer '.$self->{accessJwt}, 
		'atproto-proxy' => CHAT_PROXY,
		'atproto-accept-labelers' => CHAT_PROXY,
